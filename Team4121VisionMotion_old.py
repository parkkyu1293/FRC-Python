...
def detect_contours(img_raw):
    ...
    if largestArea > 0:
        ...
        if targetH >= targetW:
            ...
            if 11/(26.0 * math.sqrt(2)) < (targetH/targetW) and (targetH/targetW) < 11/26:
    ...
    #return results
    return numTargets, img_contours, distanceToCube, angleToCube, height_of_target, targetOffset, targetPercentWidth
